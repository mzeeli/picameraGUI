...
This is an older version where Paul and I tried to recreate the path of the beams
using two-view geometry. But it proved to be computationally intensive on the Pi so
